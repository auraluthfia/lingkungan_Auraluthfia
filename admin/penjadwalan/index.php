...
<ul class="navbar">
    ...
    <a href="/UKLSIJA/admin/transasksi_pengambilan/index.php">Transaksi Pengambilan</a>
...
<h1 class="heading">Data Penjadwalan </h1>
<a href = 'tambah-user.php'class="btn">Tambah User</a>
